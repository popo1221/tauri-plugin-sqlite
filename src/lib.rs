...
#[derive(Default)]
pub struct DbTransactions(Mutex<Vec<Option<SqliteTransaction>>>);
...
impl Builder {
    ...
    pub fn build<R: Runtime>(mut self) -> TauriPlugin<R, Option<PluginConfig>> {
        PluginBuilder::<R, Option<PluginConfig>>::new("sqlite-plus")
            .invoke_handler(tauri::generate_handler![
                commands::load,
                commands::execute,
                commands::select,
                commands::close,
                commands::sql_transaction_begin,
                commands::sql_transaction_execute,
                commands::sql_transaction_select,
                commands::sql_transaction_rollback,
                commands::sql_transaction_commit,
            ])
            .setup(|app, api| {
                ...
                run_async_command(async move {
                    ...
                    app.manage(DbTransactions::default());
